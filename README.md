...
To build the final jar and optimize the SaraBusinessInteligente application for production, run:
...
Then navigate to [http://localhost:2626](http://localhost:2626) in your browser.
