...
/**
 * REST controller for managing {@link com.sara.services.domain.Language}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Language> partialUpdateLanguage(
        ...
        Optional<Language> result = languageRepository
            ...
            .map(existingLanguage -> {
                ...
                if (language.getIsoValue() != null) {
                    existingLanguage.setIsoValue(language.getIsoValue());
                }
                if (language.getDescription() != null) {
                    existingLanguage.setDescription(language.getDescription());
                }
                if (language.getIconsrc() != null) {
                    existingLanguage.setIconsrc(language.getIconsrc());
                }
                if (language.getImgBlogIcon() != null) {
                    existingLanguage.setImgBlogIcon(language.getImgBlogIcon());
                }
                if (language.getImgBlogIconContentType() != null) {
                    existingLanguage.setImgBlogIconContentType(language.getImgBlogIconContentType());
                }
